...
export function buildPettyCashInvitationEmail({
  ...
  const subject = `BizSuits Petty Cash Vendor Onboarding${
  ...
  return {
    ...
    text: [
      `Hello ${contactName},`,
      "",
      "You have been invited to complete the BizSuits petty cash vendor onboarding form.",
      `Open this secure link to complete your registration: ${onboardingLink}`,
      "",
      "Please ensure the details you submit are accurate, especially your bank information and contact details.",
      "",
      "Regards,",
      "BizSuits",
    ].join("\n"),
    html: `
      <div style="font-family: Arial, sans-serif; color: #1f2937; line-height: 1.6;">
        ...
        <p>
          You have been invited to complete the <strong>BizSuits petty cash vendor onboarding form</strong>.
        </p>
        <p>
