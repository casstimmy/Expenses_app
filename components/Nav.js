...
export default function Nav() {
  ...
  if (role === "admin" || role === "Senior staff") {
    navLinks.push(
      ...
      { href: "/expenses/tax-analysis", label: "Tax Report" },
      ...
      <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-gradient-to-r from-white/90 to-blue-50/90 shadow-md border-b border-gray-200 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link
              href="/"
              className="flex items-center gap-1 text-2xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"
              style={{
                backgroundImage: "url('/image/4780.jpg')",
